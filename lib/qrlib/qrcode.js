...
function getLazarSoftScanner() {
    ...
    function GF256(primitive) {
        ...
        this.buildMonomial = function (degree, coefficient) {
            if (degree < 0) {$this._localMediaStream
                throw "System.ArgumentException";
            }
            if (coefficient == 0) {
                return this.zero;
    ...
    let docroot = () => qrcode.root || document;
    ...
    qrcode.setWebcam = function (videoId) {
        var n = navigator;
        qrcode.video = docroot().getElementById(videoId);
    ...
    qrcode.decode = function (src) {
        ...
        if (arguments.length === 0) {
            if (qrcode.canvas_qr2) {
                ...
                var canvas_qr = docroot().querySelector("#qr-canvas");
            ...
            image.onload = function () {
                //var canvas_qr = docroot().querySelector("#qr-canvas");
                var canvas_out = docroot().querySelector("#out-canvas");
                if (canvas_out != null) {
...
export default getLazarSoftScanner();
