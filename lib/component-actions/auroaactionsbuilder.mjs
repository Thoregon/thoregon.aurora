...
export class AuroraActionBuilderMenu extends AuroraActionBuilder  {
    constructor() {
        ...
        this._iconMenuIndicator = 'more_vert';
    ...
    get menuIconIndicator()      { return this._iconMenuIndicator;}
    set menuIconIndicator(value) { this._iconMenuIndicator = value;}

    get dense()      { return this._dense; }
    set dense(value) { this._dense = this.toBoolean(value); }
    ...
    renderActions( actions ) {
        ...
        let display = '';
        display += `<div class="aurora-actions ${classString} ">`;
        display += `    <div class="aurora-actions-trigger"><span class="material-icons">${this.menuIconIndicator}</span></div>`;
