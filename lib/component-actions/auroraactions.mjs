...
import MaterialActions        from "../../themes/material/component-actions/materialactions.mjs";

import {
    AuroraActionBuilderIconContainer,
    AuroraActionBuilderMenu,
    AuroraActionBuilderIconList,
    AuroraActionBuilderView,
    AuroraActionBuilderAvatarMenu
} from "../component-actions/auroaactionsbuilder.mjs";
...
export default class AuroraActions extends AuroraAttributeSupport(AuroraFormElement) {
    ...
    static get observedAttributes() {
        return [...super.observedAttributes, 'visible', 'mode', 'avatar'];
    }
    ...
    attributeChangedCallback(name, oldValue, newValue) {
        ...
        switch (name) {
            ...
            case 'mode':
                ...
                break;
            case 'avatar' :
                this.behavior.setAvatar(newValue);
                break;
        }
    ...
    renderActions() {
        ...
        switch ( menumode ) {
            ...
            case 'iconmenu':
                ...
                builder.menuIconIndicator = this.propertiesValues().icon;
                builder.dense = true;
                break;
            case 'menu' :
                builder = new AuroraActionBuilderMenu;
                break;
            case 'avatarmenu' :
                builder = new AuroraActionBuilderAvatarMenu({
                    avatar : this.propertiesValues().avatar,
                });
                builder.showIcons = true;
                break;
        }
    ...
    propertiesDefinitions() {
        ...
        return Object.assign(parentPropertiesValues, {
            ...
            'dense': {
                default    : 'off',
                type       : 'string',
                description: 'should a trigger be space optimized',
                group      : 'Behavior',
                example    : 'on | off'
            },
            'align': {
            ...
            'avatar' : {
                ...
                group      : 'Content',
                example    : 'https://myimage.png'
            },
            'icon'  : {
                default    : 'more_vert',
                type       : 'string',
                description: 'icon to be shown as an menu',
                group      : 'Content',
                example    : 'globe | more_vert'
            },
        });
    }
