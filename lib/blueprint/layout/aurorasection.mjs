...
const debuglog = (...args) => console.log(...args); // {};   // console.log(...args);
...
export default class AuroraSection extends AuroraBlueprintElement {
    ...
    async applyContent(container) {
        const res = await super.applyContent(container);
        return res;
    }

    connectAuroraAttributes(container) {
        return super.connectAuroraAttributes(container);
    }

    observeAuroraAttributeChanges(container) {
        return super.observeAuroraAttributeChanges(container);
    }
    ...
    parentViewModelHasBeenAttached(viewModel) {
        return super.parentViewModelHasBeenAttached(viewModel);
    }


    attributeMutated(mutation) {
        return super.attributeMutated(mutation);
    }

    nodesMutated(mutation) {
        return super.nodesMutated(mutation);
    }
