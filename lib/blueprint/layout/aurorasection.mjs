...
import MaterialSection        from "../../../themes/material/blueprint-section/materialsection.mjs";
...
*/
    attributeChangedCallback(name, oldValue, newValue) {
        ...
        switch (name) {
            case 'label' :
                // old -> this.behavior.setLabel(newValue);
                this.addInitFn(() => this.behavior.setLabel(newValue));
                break;
            case 'summary' :
