...
export default class AuroraBlueprintElement extends AuroraElement {
    ...
    get modelProperty() {
        return this.getAttribute("model-property");
    }

    set modelProperty(p) {
        this.setAttribute("model-property", p);
    }

    useModelProperty() {
        return this.hasAttribute('model-property');
    }
    ...
    get viewModelProperty() {
        return this.getAttribute("viewmodel-property");
    }

    set viewModelProperty(p) {
        this.setAttribute("viewmodel-property", p);
    }

    useViewModelProperty() {
        return this.hasAttribute('viewmodel-property');
    }
