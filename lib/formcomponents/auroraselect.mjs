...
export default class AuroraSelect extends AuroraFormElement {
    ...
    set optionsdata(optionsData) {
        ...
        this.addInitFn((async () => {
            ...
            switch (format) {
                case 'key-value' :
                    options = this.prepareOptionsDataKeyValue(current, optionsData);
                    break;
                case 'array' :
                    options = this.prepareOptionsDataArray(current, optionsData);
                    break;
                case 'grouped' :
                    options = this.prepareOptionsDataGrouped(current, optionsData);
                    break;
            }
