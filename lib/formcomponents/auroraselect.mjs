...
export default class AuroraSelect extends AuroraFormElement {
    ...
    static get observedAttributes() {
        return [...super.observedAttributes, 'label', 'placeholder', 'hint', 'leading_icon', 'trailing_icon', 'disabled', 'readonly', 'optionsdata' ];
    }
...
*/
    ...
    extractOptions() {
        ...
        this._optionDefinitionType = 'html'  //  html | function ( :options )  -> future changes
