...
import MaterialSelect         from "../../themes/material/form-select/materialselect.mjs";
...
export default class AuroraSelect extends AuroraFormElement {
    ...
    set optionsdata(optionsData) {
        console.log(">> AuroraSelect set optionsdata");
        if (this._optionsdata == optionsData) {
            console.log(">> AuroraSelect set optionsdata *: data not replaced");
            return;
        }
        console.log(">> AuroraSelect set optionsdata 2");

        this.addInitFn((async () => {
            console.log(">> AuroraSelect set optionsdata init 1");
            ...
            console.log(">> AuroraSelect set optionsdata init 2");
