...
import MaterialCard      from "../../themes/material/component-card/materialcard.mjs";
...
*/
    ...
    propertiesDefinitions() {
        ...
        return Object.assign(parentPropertiesValues, {
            ...
            icon: {
                default:        '',
                type:           'string',
                description:    'Name of the icon to be used instead of an media link',
                group:          'Content',
                example:        'globe'
            },
            mediasize: {
                ...
                group      : 'Behavior',
                example    : 'cover | contained | hidden'
            },
            'image-enabled' : {
                default:        true,
                type:           'boolean',
                description:    'in case of false it will only present the text',
                group:          'Content',
                example:        'true | false'
            },
            title: {
    ...
    */
    collectClasses() {
        ...
        if ( propertiesValues['isImageEnabled'] ) { classes.push('image-visible');}
    ...
    calculatedValues() {
        ...
        attributes['icon_html'] =   ( properties.icon )
