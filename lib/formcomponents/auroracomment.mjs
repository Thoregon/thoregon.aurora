...
export default class AuroraComment extends AuroraFormElement {
    ...
    static get observedAttributes() {
        return super.observedAttributes // ['messages'];
    }
    /*
    ...
    get repliesQuery() {
        return this.getAttribute('replies_query');
    }

    get reactionsQuery() {
        return this.getAttribute('reactions_query');
    }
    ...
    propertiesDefinitions() {
        ...
        return Object.assign(parentPropertiesValues, {
            ...
            'replies_view': {
                default:        '',
                type:           'string',
                description:    'Name of the view registered for message replies',
                group:          'Content',
                example:        ''
            },
            'reactions_query': {
 ...
 */
        ...
        let actions = await this.renderTemplate( 'commentsubactions', properties );
        let response = await this.renderTemplate( 'commentsubreplay', properties);
    ...
    collectionItemsLengthChanged() {
        super.collectionItemsLengthChanged();
    ...
    hasReplies() {
        return this.collectionView?.length || false;
    }

    totalReplies() {
        return this.collectionView?.length || 0;
    }
    ...
    get collectionView() {
        if (!this._collectionView) this._collectionView = this.container.querySelector('aurora-collection');
