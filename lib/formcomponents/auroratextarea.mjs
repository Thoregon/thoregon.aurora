...
import MaterialTextarea  from "../../themes/material/form-textarea/materialtextarea.mjs";
    ...
    propertiesDefinitions() {
        ...
        return Object.assign(parentPropertiesValues, {
            ...
            'suggestions' : {
                default    : '',
                type       : 'array',
                description: 'an array of objects defining the suggestions',
                group      : 'Content',
                example    : 'aurora-bind:sugggestions="MYFUNCTION"',
            },
            modifications: {
                default:        'none',
                type:           'string',
...
*/
    ...
    set suggestions (suggestions) {
        ...
        this.behavior.setSuggestions(suggestions);
    }
