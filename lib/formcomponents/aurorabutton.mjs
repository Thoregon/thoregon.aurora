...
import MaterialButton    from "../../themes/material/form-button/materialbutton.mjs";
...
*/
    ...
    propertiesDefinitions() {
        ...
        return Object.assign(parentPropertiesValues, {
            ...
            end_chip: {
                default:        '',
                type:           'string',
                description:    'Short text which will be shown in the end chip',
                group:          'Content',
                example:        'pdf'
            },
            end_badge : {
                default:        '',
                type:           'string',
                description:    'Short text which will be shown in the end badge',
                group:          'Content',
                example:        'pdf'
            },
            ...
            float: {
                ...
                group:          'Style',
                example:        'left | center | right | full'
            },
            borderstyle: {
                default:        '',
                type:           'string',
    ...
    */
    collectClasses() {
        ...
        if ( propertiesValues['end_chip'])   { classes.push('endChip_used');}
        if ( propertiesValues['end_badge'])  { classes.push('end_badge_used');}
