/**
 *
 * specify a mapper for the item <-> listitem
 * to determine the attributes for the list item
 *
 * @author: Martin Neitz, Bernhard Lukassen
 */

import AuroraFormElement from "./auroraformelement.mjs";
import Materiallistitem  from "../../themes/material/component-listitem/materiallistitem.mjs";
