...
import Materialcheckbox  from "../../themes/material/form-checkbox/materialcheckbox.mjs";
    ...
    propertiesDefinitions() {
        ...
        return Object.assign(parentPropertiesValues, {
            ...
            val: {
                default:        '',
                type:           'string',
                description:    'The value to be set in case the checkbox is set',
                group:          'Content',
                example:        'yes'
            },
            valtype: {
                default:        'string',
                type:           'string',
                description:    'how the value should be converted into',
                group:          'Content',
            ...
            hint: {
                default:        '',
                type:           'string',
                description:    'A text that will describe the Field in more detail',
                group:          'Content',
                example:        'This challenge is gain more customers'
            }
        });
    }
