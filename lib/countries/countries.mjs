...
export default class Countries {
    ...
    async initialize() {
        this.countries = JSON.parse( await thoregon.source("/thoregon.aurora/lib/countries/countries.json") );
        this.usstates  = JSON.parse( await thoregon.source("/thoregon.aurora/lib/countries/usstates.json") );
    }
    ...
    getFlagUrl( code ) {
        ...
        if (code.length == 3) {
            code = this.convertIntoAlpha2(code);
        }
