        ...
        var stackBlur = (function () {
            ...
            function getImageDataFromCanvas(canvas, top_x, top_y, width, height) {
                if (typeof (canvas) == 'string')
                    canvas = this._container.getElementById(canvas);
...
// events
        ...
        var CropArea = function (container) {
            var resizers = {
            ...
            return function () {
                function CropArea() {
                    ...
                    var container = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined  /*document*/;
                ...
                _createClass(CropArea, [{
                    ...
                    value: function _init() {
                        ...
                        addEvents(this._container, Events.DOWN, this);
                    }
                }, {
                    key  : 'reset',
                    ...
                    value: function _onStartDrag(e) {
                        ...
                        addEvents(this._container, Events.MOVE, this);
                        addEvents(this._container, Events.UP, this);
                    ...
                    value: function _onStopDrag(e) {
                        ...
                        removeEvents(this._container, Events.MOVE, this);
                        removeEvents(this._container, Events.UP, this);
                    ...
                    value: function destroy() {
                        ...
                        if (this._uid) delete SlimPopover[this._uid];

                        removeEvents(this._container, Events.DOWN, this);
                        removeEvents(this._container, Events.MOVE, this);
                        removeEvents(this._container, Events.UP, this);
        ...
        var ImageEditor = function () {
            ...
            var ImageEditor = function () {
                function ImageEditor() {
                    ...
                    var container = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined  /*document*/;
                ...
                _createClass(ImageEditor, [{
                    ...
                    value: function _init() {
                        ...
                        // create crop marks
                        this._cropper = new CropArea(this._container);
        ...
        var FileHopper = function (container) {
            /**
             * FileHopper
             * @param element
             * @param options
        ...
        var Popover = function (container) {
            /**
             * Popover
             */
            return function () {
        ...
        var Slim = function () {
            function Slim(element) {
                ...
                // if (!SlimPopover[this._uid]) {
                    SlimPopover[this._uid] = new Popover(container);
                // }
            ...
            _createClass(Slim, [{
                ...
                value: function _init() {
                    ...
                    if (this._isImageOnly()) {
                        ...
                        // setup hopper
                        this._imageHopper           = new FileHopper(this._container);
                ...
                value: function _load(resource, callback) {
                    ...
                    setTimeout(() => this.delegate?.imageLoaded(), 100);
                }
            }, {
                key  : '_loadCanvas',
                ...
                value: function _showEditor() {
                    SlimPopover[this._uid].className = this._options.popoverClassName;

                    SlimPopover[this._uid].show();
                ...
                value: function _doEdit() {
                    ...
                    // append to popover
                    SlimPopover[this._uid].inner = this._imageEditor.element;
                ...
                value: function _doDestroy() {
                    ...
                    if (SlimPopover && SlimCount === 0) {
                        SlimPopover[this._uid].destroy();
                        SlimPopover[this._uid] = null;
                    }
