...
export default class UIRouter /*extends BrowserRouter*/ {
    ...
    restore() {
        ...
        (async () => {
            ...
            if (!this._containerContent) {
                this._containerContent = this.appelement.getBlueprintContainer().containerContent;
            }
            if (!route.is_empty) {
    ...
    async toView(route, appelement) {
        ...
        if (!route || route.is_empty) return this.showInitialContainerContent(appelement);
    ...
    // todo [REFACTOR]: restore the initial view in the container
    showInitialContainerContent(appelement) {
        if (this._containerContent) this.appelement.getBlueprintContainer().containerContent = this._containerContent;
    }
