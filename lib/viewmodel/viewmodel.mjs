...
export default class ViewModel extends VmEventEmitter(Reporter(Object)) {
    ...
    constructor(...args) {
        ...
        this.modelMutationListener = (evt) => {
            this.invokePathListeners('model', evt.prop);
            this.invokeMutationListeners();
        }
    }
...
*/
    ...
    invokeMutationListeners() {
        ...
        if (this.model) this.modelWasMutated();
    }
    ...
    dispose() {
        ...
        this.removeEventListener('change', this.modelMutationListener);
    }
