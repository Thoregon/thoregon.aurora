...
import { val }        from "../../../thoregon.crystalline/lib/thoregon/util.mjs";
                ...
                pathListeners.forEach(async (pathListener) => {
                    try {
                        ...
                        if (!lpath || lpath === path) {
                            ...
                            const value = await this.getValueModelPath(path);
                            listener({ value });
                        }
                    } catch (e) {
