...
export default class ModelObject extends ModelDelegate {
    ...
    constructor(viewModel) {
        super(viewModel);
        this.items = {};
        this.mutationListener = (evt) => this.modelMutated(evt);
    }
    ...
    attachModel(model) {
        ...
        model.addEventListener('change', this.mutationListener);
    }
    ...
    dispose() {
        this.model.removeEventListener('change', this.mutationListener);
    }
