...
import MaterialNavigationItem from "../../themes/material/component-navigationitem/materialnavigationitem.mjs";
...
export default class AuroraNavigationItem extends AuroraFormElement {
    ...
    static get observedAttributes() {
        return [...super.observedAttributes, 'label', 'class', 'mode', 'collapse'];
    }
    ...
    collectClasses() {
        ...
        if ( propertiesValues['collapse'] )  { classes.push( 'collapse' ); }
