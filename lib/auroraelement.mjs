...
export default class AuroraElement extends UIElement {
    ...
    static get uiThemeRoot() {
        return this.delivery('/thoregon.aurora/themes');
    }

    static get uiComponentRoot() {
        return this._uiroot ? this.delivery(this._uiroot) : this.uiThemeRoot;
    }
    ...
    async elementStyle(templatename) {
        ...
        return await Q(`${cacheid}/style`, async () => {
            ...
            // sytle for general theme
            csspath   = `${this.constructor.uiThemeRoot}/${theme}/${theme}.css`;
