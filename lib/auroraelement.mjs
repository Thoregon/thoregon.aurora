...
import ComponentStatus from "../../../evolux.modules/evolux.dyncomponents/lib/controller/componentstatus.mjs";
...
export default class AuroraElement extends UIElement {
    ...
    async renderTemplate( templateName, properties ) {
    ...
    async applyTemplates(container) {
        ...
        let element = await this.renderTemplate( this.appliedTemplateName ,properties);
