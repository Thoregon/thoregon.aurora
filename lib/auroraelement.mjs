...
export default class AuroraElement extends UIElement {
    ...
    async refresh() {
        ...
        await this.viewModel.refreshView(this);
        /*
                this.refreshContainer(async () => {
                    delete this.behavior;
    ...
    static get uiComponentRoot() {
        return this._uiroot ? this._uiroot : '/thoregon.aurora/themes';
    }
            ...
            if (!_colors) {
                try {
                    ...
                    if (res.ok) {
                        ...
                        if (colorCSS) _colors = colorCSS;
                    } else {
                        _colors = this.asColorCSS({});
                    }
                } catch (ignore) { }
            } else {
                styles.push(_colors);            }
    ...
    asColorCSS(colorDefs) {
        // return (this.behavior) ? this.behavior.asColorCSS(colorDefs) : undefined;
    }
...
*/
    ...
    get expandedChildNodes() {
        return this.allChildNodes( [...this.container.children]);
    }
