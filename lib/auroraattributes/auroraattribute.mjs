...
export default class AuroraAttribute {
    ...
    static with(elem, { name, value } = {}) {
        ...
        attribute.connectElementListener(elem);
        return attribute;
    }
    ...
    /**
     * add all necessary listeners to the element
     * @param elem
     */
    connectElementListener(elem) {
    ...
    getNamedListener(name, fn) {
        if (!this.namedListeners) this.namedListeners = {};
        let listener = this.namedListeners[name];
        if (!listener && fn) {
            listener = fn;
            this.namedListeners[name] = fn;
        }
        return listener;
    }

    getAllNamedListenersArray() {
        return this.namedListeners ? Object.values(this.namedListeners) : [];
    }
    ...
    detach() {
        ...
        oldViewModel.removeAllListeners(this.getAllNamedListenersArray());
    }
