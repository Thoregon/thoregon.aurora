...
export default class AuroraAttributeName extends AuroraAttribute {
    ...
    connectElementListeners(element) {
        // console.log("** AuroraAttributeName: connectElementListeners", element?.name, this.attribute?.name);
    ...
    elementValueChanged(evt){
        ...
        try {
            ...
            switch (this.elementType) {
                ...
                //     value = value.filter(elem => elem != undefined);
                //     value = [...new Set(value)];
                //     break;
            }
            ...
            console.error(">> aurora-name > modelValueChanged", e);
        } finally {
            delete this._active;
        }
    }
    ...
    activeWatchdog() {
        setTimeout(() => this._active = false, 300);
    }
