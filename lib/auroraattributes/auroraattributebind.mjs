...
import { isFunction, isObject, deepCompare } from "/evolux.util/index.mjs";
import { isUFD }                             from "/thoregon.truCloud/lib/commons.mjs";
...
*/
    ...
    async modelMutated(reties = 2) {
        ...
        try {
            ...
            if (reties >= 0) {
                setTimeout(() => this.modelMutated(reties - 1), 200);
            } else {
                console.log(`aurora-bind: '${this.attribute.value}' eval error >`, e.message,e.stack);
            }
        }
        delete this._active;
    }
