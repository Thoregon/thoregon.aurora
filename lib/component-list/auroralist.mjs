...
export class AuroraListHandler {
    ...
    renderActions(listItemViewModel, actionDefinition ) {
        return `<aurora-actions mode="${actionDefinition.actionstyle}" position="${actionDefinition.align}" aurora-bind:actions="getActions('${actionDefinition.actionset}')"></aurora-actions>`;
    }
