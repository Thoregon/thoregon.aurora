...
//                this.container.innerHTML = this.renderGrid( query, columns );
    ...
    viewpath() {
        ...
        while (parentAuroraView && !parentAuroraView.vpath) parentAuroraView = this.parentAuroraElement();
        return parentAuroraView?.vpath;
    }
        ...
        const columnDefinitions = columnElements.map(columnElement => (
            {
                ...
                header    : columnElement.querySelector('header'),   // todo
