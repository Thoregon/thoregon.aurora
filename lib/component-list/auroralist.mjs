...
export class AuroraListHandler {
    ...
    renderActions(listItemViewModel, actionDefinition ) {
        ...
        return "<aurora-actions></aurora-actions>"
        switch (actionDefinition.actionstyle) {
            case "iconcontainer":
                return this.actionBuilderIconContainer.renderActions(listItemViewModel, actionDefinition.set );
            case "menu":
            default:
                return this.actionBuilderMenu.renderActions(listItemViewModel, actionDefinition.set );
                break;
        }
